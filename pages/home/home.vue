<template>
	<view 
		:style="{
			backgroundColor: `${originData.color2}`,
		}">
		...
		>
			...
			<view class="header u-p-10 box-border"> 
				<view class="u-p-l-10 u-p-r-10 u-flex u-flex-items-center">
					<view class="bg-white u-p-4 u-radius-6 u-flex-1">
						<SearchBase></SearchBase>
					</view>
					<view class="u-m-l-10 u-p-l-10 u-p-r-10">
				...
				<view class="u-flex u-flex-between swiper-w ">
					...
					<view class="item u-flex u-flex-between ">
						<view class="u-flex-1 u-p-10" v-for="(item,index) in list" :key="index">
							<view style="width: 100%; height: 100%;overflow: hidden;" class="u-radius-8"
								@click="goto(item)"
							>
								<zeroLazyLoad
									:image="item.img" 
				...
				<view class=" u-p-10" v-if="list2[0]"> 
					<img
						@click="goto(list2[0])"
						class="u-radius-8"
						:src="list2[0].img"
				...
				<!-- <view class="ad-w u-flex u-flex-between u-p-t-10 u-p-b-10" v-if="list2">
				...
				<view class="u-p-10"
					...
					:key="index"
				> 
					<view class="bg-white u-radius-12 u-p-l-20 u-p-t-20 u-p-r-20 " >
						<CompanyRowCard
							mode="small"
							:origin="item"
						></CompanyRowCard>
