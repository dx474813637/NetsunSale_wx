<template>
	<navBar
		...
		activeColor="#fff"
	> 
		<view class="nav-w u-flex u-flex-between box-border u-flex-items-center u-p-l-15 box-border" style="width: 100%; height: 100%;max-width: 100%;"> 
							...
							<template #content>
								<view class="card-content u-p-20 u-font-30">
									<view class="u-line-2 u-m-b-10 card-content-name">
										<text class="card-content-tag u-m-r-8">优选</text>
										<text>{{item.name}}</text>
									</view>
