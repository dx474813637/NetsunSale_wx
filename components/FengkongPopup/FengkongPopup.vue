		...
		>
			<view class="wrapper">
				<view class="wrapper-header  u-p-20 "> 
					<slot name="header">
						<view class="u-flex u-flex-center u-flex-items-center u-error"> 
							提示
						</view>
					</slot> 
				</view>
				<view class="wrapper-main" :style="{backgroundColor: bgColor}">
					<view class="list-w bg-white u-p-20">
						<view class=" u-flex u-flex-center u-flex-items-center">
							<u-icon size="80" name="warning" color="#f00"></u-icon>
						</view>
						<view class="main-list  u-p-20 u-flex u-flex-center u-flex-items-center" > 
							{{info}}
						</view>  
					</view>  
				</view>
				<view class="wrapper-footer u-flex u-flex-items-center u-flex-between text-base">
					<slot name="footer">
						...
						<view class="item u-flex-1 u-p-20 u-flex u-flex-center u-error" @click="confirmBtn">
							确认并支付
						</view>
					</slot>
